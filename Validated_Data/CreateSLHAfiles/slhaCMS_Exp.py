...
def main():
    base_path = Path("/home/yoxara/MG5_aMC_v3_5_1/xsec_ppZp_CMS_Exp/Events/")
    banner_paths = [base_path / f"run_{i:02d}/run_{i:02d}_tag_1_banner.txt" for i in range(1, 35)]
    
    output_dir = Path("/home/yoxara/2MDM/Validated_Data/slhaFiles/xsec_ppZp_CMS_Exp")
