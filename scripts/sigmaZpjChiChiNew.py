...
file_path = f"{base_path}/scripts/sigmaZpChiChijNew.txt"
MZp_values = list(range(200, 3600, 200))
gqV_values = [0.1]
with open(file_path, "w") as f:
    ...
    f.write(f"output {base_path}/2mdm_sigmaZpChiChijNew\n")
    f.write(f"launch {base_path}/2mdm_sigmaZpChiChijNew\n")
    ...
    f.write("set param_card ychi 1.5\n")
    ...
    f.write(f"launch {base_path}/2mdm_sigmaZpChiChijNew -i\n")
    f.write(f"print_results --path={base_path}/data/sigmaZpChiChijNew.txt --format=short\n")
    f.write("exit\n")