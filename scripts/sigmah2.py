...
with open(file_path, "w") as f:
    ...
    f.write("define j = p \n")
    f.write("generate p p > h [noborn=QCD]\n")
    f.write(f"output {base_path}/2mdm_sigmah2nlo\n")
    f.write(f"launch {base_path}/2mdm_sigmah2nlo\n")
    ...
    f.write("set param_card MSd 400\n")
    ...
    f.write(f"launch {base_path}/2mdm_sigmah2nlo -i\n")
