...
file_path = f"{base_path}/scripts/sigmaZpxxj.txt"
...
with open(file_path, "w") as f:
    ...
    f.write(f"output {base_path}/2mdm_sigmaZpXdXdj\n")
    f.write(f"launch {base_path}/2mdm_sigmaZpXdXdj\n")
    ...
    f.write(f"launch {base_path}/2mdm_sigmaZpXdXdj -i\n")
    f.write(f"print_results --path={base_path}/data/sigmaZpXdXdj.txt --format=short\n")
    f.write("exit\n")