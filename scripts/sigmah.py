...
file_path = f"{base_path}/scripts/sigmah.txt"
...
with open(file_path, "w") as f:
    ...
    f.write(f"output {base_path}/2mdm_sigmahnlo\n")
    f.write(f"launch {base_path}/2mdm_sigmahnlo\n")
    ...
    f.write("set param_card ychi 1.0\n")
    ...
    f.write(f"launch {base_path}/2mdm_sigmah -i\n")
    f.write(f"print_results --path={base_path}/data/sigmah.txt --format=short\n")
    f.write("exit\n")