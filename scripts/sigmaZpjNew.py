...
file_path = f"{base_path}/scripts/sigmaZpjNew.txt"
...
with open(file_path, "w") as f:
    ...
    f.write(f"output {base_path}/2mdm_sigmaZpjNew\n")
    f.write(f"launch {base_path}/2mdm_sigmaZpjNew\n")
    ...
    f.write(f"launch {base_path}/2mdm_sigmaZpjNew -i\n")
    f.write(f"print_results --path={base_path}/data/sigmaZpjNew.txt --format=short\n")
    f.write("exit\n")