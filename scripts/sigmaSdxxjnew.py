...
file_path = f"{base_path}/scripts/sigmaSdNewnlo.txt"
...
with open(file_path, "w") as f:
    ...
    f.write(f"output {base_path}/2mdm_sigmaSdNewnlo\n")
    f.write(f"launch {base_path}/2mdm_sigmaSdNewnlo\n")
    ...
    f.write(f"launch {base_path}/2mdm_sigmaSdNewnlo -i\n")
    f.write(f"print_results --path={base_path}/data/sigmaSdNewnlo.txt --format=short\n")
    f.write("exit\n")