...
Decay_H1 = Decay(name = 'Decay_H1',
                 ...
                 partial_widths = {(P.H2,P.H2):'((Ca**6*lam3**2*vev**2 + 12*Ca**4*lam1*lam3*Sa**2*vev**2 - 4*Ca**4*lam3**2*Sa**2*vev**2 + 36*Ca**2*lam1**2*Sa**4*vev**2 - 24*Ca**2*lam1*lam3*Sa**4*vev**2 + 4*Ca**2*lam3**2*Sa**4*vev**2 - 12*Ca**5*lam2*lam3*Sa*vev*xev + 4*Ca**5*lam3**2*Sa*vev*xev - 72*Ca**3*lam1*lam2*Sa**3*vev*xev + 24*Ca**3*lam1*lam3*Sa**3*vev*xev + 24*Ca**3*lam2*lam3*Sa**3*vev*xev - 10*Ca**3*lam3**2*Sa**3*vev*xev - 12*Ca*lam1*lam3*Sa**5*vev*xev + 4*Ca*lam3**2*Sa**5*vev*xev + 36*Ca**4*lam2**2*Sa**2*xev**2 - 24*Ca**4*lam2*lam3*Sa**2*xev**2 + 4*Ca**4*lam3**2*Sa**2*xev**2 + 12*Ca**2*lam2*lam3*Sa**4*xev**2 - 4*Ca**2*lam3**2*Sa**4*xev**2 + lam3**2*Sa**6*xev**2)*cmath.sqrt(MH1**4 - 4*MH1**2*MH2**2))/(32.*cmath.pi*abs(MH1)**3)',
                                   (P.chi,P.chi):'((-4*MchiT**2*Sa**2*ychi**2 + MH1**2*Sa**2*ychi**2)*cmath.sqrt(-4*MchiT**2*MH1**2 + MH1**4))/(32.*cmath.pi*abs(MH1)**3)',
                                   (P.d,P.d__tilde__):'((-12*Ca**2*MD**2*ydo**2 + 3*Ca**2*MH1**2*ydo**2)*cmath.sqrt(-4*MD**2*MH1**2 + MH1**4))/(16.*cmath.pi*abs(MH1)**3)',
                                   (P.s,P.s__tilde__):'((3*Ca**2*MH1**2*ys**2 - 12*Ca**2*MS**2*ys**2)*cmath.sqrt(MH1**4 - 4*MH1**2*MS**2))/(16.*cmath.pi*abs(MH1)**3)',
                                   (P.b,P.b__tilde__):'((-12*Ca**2*MB**2*yb**2 + 3*Ca**2*MH1**2*yb**2)*cmath.sqrt(-4*MB**2*MH1**2 + MH1**4))/(16.*cmath.pi*abs(MH1)**3)',
                                   (P.e__minus__,P.e__plus__):'((-4*Ca**2*Me**2*ye**2 + Ca**2*MH1**2*ye**2)*cmath.sqrt(-4*Me**2*MH1**2 + MH1**4))/(16.*cmath.pi*abs(MH1)**3)',
                                   (P.mu__minus__,P.mu__plus__):'((Ca**2*MH1**2*ym**2 - 4*Ca**2*MMU**2*ym**2)*cmath.sqrt(MH1**4 - 4*MH1**2*MMU**2))/(16.*cmath.pi*abs(MH1)**3)',
                                   (P.ta__minus__,P.ta__plus__):'((Ca**2*MH1**2*ytau**2 - 4*Ca**2*MTA**2*ytau**2)*cmath.sqrt(MH1**4 - 4*MH1**2*MTA**2))/(16.*cmath.pi*abs(MH1)**3)',
                                   (P.u,P.u__tilde__):'((3*Ca**2*MH1**2*yup**2 - 12*Ca**2*MU**2*yup**2)*cmath.sqrt(MH1**4 - 4*MH1**2*MU**2))/(16.*cmath.pi*abs(MH1)**3)',
                                   (P.c,P.c__tilde__):'((-12*Ca**2*MC**2*yc**2 + 3*Ca**2*MH1**2*yc**2)*cmath.sqrt(-4*MC**2*MH1**2 + MH1**4))/(16.*cmath.pi*abs(MH1)**3)',
                                   ...
                                   (P.Zp,P.Zp):'((192*gchi**4*gZp**4*Sa**2*xev**2 + (16*gchi**4*gZp**4*MH1**4*Sa**2*xev**2)/MZp**4 - (64*gchi**4*gZp**4*MH1**2*Sa**2*xev**2)/MZp**2)*cmath.sqrt(MH1**4 - 4*MH1**2*MZp**2))/(32.*cmath.pi*abs(MH1)**3)'})
...
Decay_H2 = Decay(name = 'Decay_H2',
                 ...
                 partial_widths = {(P.H1,P.H1):'((36*Ca**4*lam1**2*Sa**2*vev**2 - 24*Ca**4*lam1*lam3*Sa**2*vev**2 + 4*Ca**4*lam3**2*Sa**2*vev**2 + 12*Ca**2*lam1*lam3*Sa**4*vev**2 - 4*Ca**2*lam3**2*Sa**4*vev**2 + lam3**2*Sa**6*vev**2 + 12*Ca**5*lam1*lam3*Sa*vev*xev - 4*Ca**5*lam3**2*Sa*vev*xev + 72*Ca**3*lam1*lam2*Sa**3*vev*xev - 24*Ca**3*lam1*lam3*Sa**3*vev*xev - 24*Ca**3*lam2*lam3*Sa**3*vev*xev + 10*Ca**3*lam3**2*Sa**3*vev*xev + 12*Ca*lam2*lam3*Sa**5*vev*xev - 4*Ca*lam3**2*Sa**5*vev*xev + Ca**6*lam3**2*xev**2 + 12*Ca**4*lam2*lam3*Sa**2*xev**2 - 4*Ca**4*lam3**2*Sa**2*xev**2 + 36*Ca**2*lam2**2*Sa**4*xev**2 - 24*Ca**2*lam2*lam3*Sa**4*xev**2 + 4*Ca**2*lam3**2*Sa**4*xev**2)*cmath.sqrt(-4*MH1**2*MH2**2 + MH2**4))/(32.*cmath.pi*abs(MH2)**3)',
                                   (P.chi,P.chi):'((-4*Ca**2*MchiT**2*ychi**2 + Ca**2*MH2**2*ychi**2)*cmath.sqrt(-4*MchiT**2*MH2**2 + MH2**4))/(32.*cmath.pi*abs(MH2)**3)',
                                   (P.d,P.d__tilde__):'((-12*MD**2*Sa**2*ydo**2 + 3*MH2**2*Sa**2*ydo**2)*cmath.sqrt(-4*MD**2*MH2**2 + MH2**4))/(16.*cmath.pi*abs(MH2)**3)',
                                   (P.s,P.s__tilde__):'((3*MH2**2*Sa**2*ys**2 - 12*MS**2*Sa**2*ys**2)*cmath.sqrt(MH2**4 - 4*MH2**2*MS**2))/(16.*cmath.pi*abs(MH2)**3)',
                                   (P.b,P.b__tilde__):'((-12*MB**2*Sa**2*yb**2 + 3*MH2**2*Sa**2*yb**2)*cmath.sqrt(-4*MB**2*MH2**2 + MH2**4))/(16.*cmath.pi*abs(MH2)**3)',
                                   (P.e__minus__,P.e__plus__):'((-4*Me**2*Sa**2*ye**2 + MH2**2*Sa**2*ye**2)*cmath.sqrt(-4*Me**2*MH2**2 + MH2**4))/(16.*cmath.pi*abs(MH2)**3)',
                                   (P.mu__minus__,P.mu__plus__):'((MH2**2*Sa**2*ym**2 - 4*MMU**2*Sa**2*ym**2)*cmath.sqrt(MH2**4 - 4*MH2**2*MMU**2))/(16.*cmath.pi*abs(MH2)**3)',
                                   (P.ta__minus__,P.ta__plus__):'((MH2**2*Sa**2*ytau**2 - 4*MTA**2*Sa**2*ytau**2)*cmath.sqrt(MH2**4 - 4*MH2**2*MTA**2))/(16.*cmath.pi*abs(MH2)**3)',
                                   (P.u,P.u__tilde__):'((3*MH2**2*Sa**2*yup**2 - 12*MU**2*Sa**2*yup**2)*cmath.sqrt(MH2**4 - 4*MH2**2*MU**2))/(16.*cmath.pi*abs(MH2)**3)',
                                   (P.c,P.c__tilde__):'((-12*MC**2*Sa**2*yc**2 + 3*MH2**2*Sa**2*yc**2)*cmath.sqrt(-4*MC**2*MH2**2 + MH2**4))/(16.*cmath.pi*abs(MH2)**3)',
                                   ...
                                   (P.Zp,P.Zp):'((192*Ca**2*gchi**4*gZp**4*xev**2 + (16*Ca**2*gchi**4*gZp**4*MH2**4*xev**2)/MZp**4 - (64*Ca**2*gchi**4*gZp**4*MH2**2*xev**2)/MZp**2)*cmath.sqrt(MH2**4 - 4*MH2**2*MZp**2))/(32.*cmath.pi*abs(MH2)**3)'})
...
Decay_Zp = Decay(name = 'Decay_Zp',
                 particle = P.Zp,
                 partial_widths = {(P.u,P.u__tilde__):'((-48*gqA**2*MU**2 + 24*gq**2*gZp**2*MU**2 + 12*gqA**2*MZp**2 + 12*gq**2*gZp**2*MZp**2)*cmath.sqrt(-4*MU**2*MZp**2 + MZp**4))/(48.*cmath.pi*abs(MZp)**3)',
                                   (P.c,P.c__tilde__):'((-48*gqA**2*MC**2 + 24*gq**2*gZp**2*MC**2 + 12*gqA**2*MZp**2 + 12*gq**2*gZp**2*MZp**2)*cmath.sqrt(-4*MC**2*MZp**2 + MZp**4))/(48.*cmath.pi*abs(MZp)**3)',
                                   (P.t,P.t__tilde__):'((-48*gqA**2*MT**2 + 24*gq**2*gZp**2*MT**2 + 12*gqA**2*MZp**2 + 12*gq**2*gZp**2*MZp**2)*cmath.sqrt(-4*MT**2*MZp**2 + MZp**4))/(48.*cmath.pi*abs(MZp)**3)',
                                   (P.d,P.d__tilde__):'((-48*gqA**2*MD**2 + 24*gq**2*gZp**2*MD**2 + 12*gqA**2*MZp**2 + 12*gq**2*gZp**2*MZp**2)*cmath.sqrt(-4*MD**2*MZp**2 + MZp**4))/(48.*cmath.pi*abs(MZp)**3)',
                                   (P.s,P.s__tilde__):'((-48*gqA**2*MS**2 + 24*gq**2*gZp**2*MS**2 + 12*gqA**2*MZp**2 + 12*gq**2*gZp**2*MZp**2)*cmath.sqrt(-4*MS**2*MZp**2 + MZp**4))/(48.*cmath.pi*abs(MZp)**3)',
                                   (P.b,P.b__tilde__):'((-48*gqA**2*MB**2 + 24*gq**2*gZp**2*MB**2 + 12*gqA**2*MZp**2 + 12*gq**2*gZp**2*MZp**2)*cmath.sqrt(-4*MB**2*MZp**2 + MZp**4))/(48.*cmath.pi*abs(MZp)**3)',
                                   (P.chi,P.chi):'((-16*gchi**2*MchiT**2 + 4*gchi**2*MZp**2)*cmath.sqrt(-4*MchiT**2*MZp**2 + MZp**4))/(96.*cmath.pi*abs(MZp)**3)'})
