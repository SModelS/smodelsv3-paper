...
Decay_Zp = Decay(name = 'Decay_Zp',
                 particle = P.Zp,
                 partial_widths = {(P.u,P.u__tilde__):'(MZp**2*(12*gqA**2*MZp**2 + 12*gq**2*gZp**2*MZp**2))/(48.*cmath.pi*abs(MZp)**3)',
                                   (P.c,P.c__tilde__):'(MZp**2*(12*gqA**2*MZp**2 + 12*gq**2*gZp**2*MZp**2))/(48.*cmath.pi*abs(MZp)**3)',
                                   ...
                                   (P.d,P.d__tilde__):'(MZp**2*(12*gqA**2*MZp**2 + 12*gq**2*gZp**2*MZp**2))/(48.*cmath.pi*abs(MZp)**3)',
                                   (P.s,P.s__tilde__):'(MZp**2*(12*gqA**2*MZp**2 + 12*gq**2*gZp**2*MZp**2))/(48.*cmath.pi*abs(MZp)**3)',
                                   (P.b,P.b__tilde__):'(MZp**2*(12*gqA**2*MZp**2 + 12*gq**2*gZp**2*MZp**2))/(48.*cmath.pi*abs(MZp)**3)',
