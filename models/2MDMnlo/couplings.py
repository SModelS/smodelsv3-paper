...
GC_108 = Coupling(name = 'GC_108',
                  value = '8*Ca*complex(0,1)*g1p**2*gchi**2*xev',
                  order = {'NP':2,'QED':1})

GC_109 = Coupling(name = 'GC_109',
                  value = '-8*complex(0,1)*g1p**2*gchi**2*Sa*xev',
                  order = {'NP':2,'QED':1})
...
GC_19 = Coupling(name = 'GC_19',
                 value = '8*complex(0,1)*g1p**2*gchi**2',
                 order = {'NP':2,'QED':2})
...
GC_20 = Coupling(name = 'GC_20',
                 value = '8*Ca**2*complex(0,1)*g1p**2*gchi**2',
                 order = {'NP':2,'QED':2})
...
GC_33 = Coupling(name = 'GC_33',
                 value = '-8*Ca*complex(0,1)*g1p**2*gchi**2*Sa',
                 order = {'NP':2,'QED':2})

GC_34 = Coupling(name = 'GC_34',
                 value = '8*complex(0,1)*g1p**2*gchi**2*Sa**2',
                 order = {'NP':2,'QED':2})
