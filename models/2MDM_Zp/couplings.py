...
GC_13 = Coupling(name = 'GC_13',
                 value = '(complex(0,1)*g1p*gchi)/2.',
                 order = {'NP':1,'QED':1})

GC_14 = Coupling(name = 'GC_14',
                 value = 'complex(0,1)*g1p*gq',
                 order = {'NP':1,'QED':1})
...
GC_16 = Coupling(name = 'GC_16',
                 value = '2*complex(0,1)*g1p**2*gsd**2',
                 order = {'NP':2,'QED':2})

GC_17 = Coupling(name = 'GC_17',
                 value = '2*Ca**2*complex(0,1)*g1p**2*gsd**2',
                 order = {'NP':2,'QED':2})
...
GC_62 = Coupling(name = 'GC_62',
                 value = '-2*Ca*complex(0,1)*g1p**2*gsd**2*Sa',
                 order = {'NP':2,'QED':2})

GC_63 = Coupling(name = 'GC_63',
                 value = '2*complex(0,1)*g1p**2*gsd**2*Sa**2',
                 order = {'NP':2,'QED':2})
...
GC_134 = Coupling(name = 'GC_134',
                  value = '-0.25*(Ca*complex(0,1)*Mchi)/xev',
                  order = {'QED':1})

GC_135 = Coupling(name = 'GC_135',
                  value = '(complex(0,1)*Mchi*Sa)/(4.*xev)',
                  order = {'QED':1})

GC_136 = Coupling(name = 'GC_136',
                  value = '2*Ca*complex(0,1)*g1p**2*gsd**2*xev',
                  order = {'NP':2,'QED':1})

GC_137 = Coupling(name = 'GC_137',
                  value = '-2*complex(0,1)*g1p**2*gsd**2*Sa*xev',
                  order = {'NP':2,'QED':1})
